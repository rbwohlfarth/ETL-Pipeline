...
BEGIN { use_ok( 'RawData::Parser::Excel2007' ); }
require_ok( 'RawData::Parser::Excel2007' );
...
my $file = new_ok( 'RawData::Parser::Excel2007' );


# open()
is( $file->file( 't/Excel2007.xlsx' ), 't/Excel2007.xlsx', 'open()'        );
